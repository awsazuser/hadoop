...
ADD bootstrap_master.sh /usr/local/hadoop/bootstrap_master.sh
ADD bootstrap_slave.sh /usr/local/hadoop/bootstrap_slave.sh

RUN chmod 700 /usr/local/hadoop/bootstrap_master.sh
RUN chmod 700 /usr/local/hadoop/bootstrap_slave.sh
